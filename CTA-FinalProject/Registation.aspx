    ...
    <form id="form1" runat="server">
         <table>
            ...
            <tr>
             ...
             <tr>
                <td>CTA Card Number:</td>
                <td class="auto-style3"><asp:TextBox ID="CTATextBox" runat="server"></asp:TextBox></td>
                   <td><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Display="Dynamic" ErrorMessage="* CTA Card Number is required" ControlToValidate="CTATextBox" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                  </td>                   
            </tr>
             <tr>   
                <td></td>
